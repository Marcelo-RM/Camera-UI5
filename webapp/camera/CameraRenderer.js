sap.ui.define([],
    function () {
        ...
        CameraRenderer.render = function (oRm, oControl) {
            ...
            oRm.write("</div>");
*/
            var sInput = ' <button class="sapMBtnBase sapMBtn" id="__Button-Camera"> ' +
                ' <div class="sapMBtnInner sapMBtnHoverable sapMFocusable sapMBtnIconFirst sapMBtnDefault"> ' +
                ' <input style="display:none" type="file" id="__Input-Camera" accept="image/*"> ' +
                ' <span id="__Icon-camera" role="presentation" aria-hidden="true" data-sap-ui-icon-content="" class="sapUiIcon sapUiIconMirrorInRTL sapMBtnCustomIcon sapMBtnIcon sapMBtnIconLeft" style="font-family: \'SAP-icons\';"> ' +
                ' </span> ' +
                ' </div> ' +
                ' </button> ';
            oRm.write(sInput);
